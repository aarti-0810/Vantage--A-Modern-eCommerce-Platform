    ...
    return (
        <div className="signin-container">
            <header className="logo">
                <a href="https://ibb.co/VMch1hM">
                    <img src="https://i.ibb.co/NWdkvkW/abc.png" alt="logo" />
                </a>
            </header>
                ...
                <form className="signin-form">
                    <div className="signin-form-content">
                        ...
                        <Link to="/Registration" className="signin-create-account-link">
                            <button className="signin-create-account-button">Create your Amazon account</button>
                        </Link>
                    </div>
                </form>
            </div>
            <footer className="signin-footer">
                ...
                <p className="signin-footer-text">© 1996-2024, Amazon.com, Inc. or its affiliates</p>
            </footer>
        </div>
    );
}
